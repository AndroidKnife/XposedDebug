package com.hwangjr.xposed.mods.wechat;
...
/**
 * Make blur image in friends area shown without red gift!
 */
public class FriendsAreaBlurImage implements IXposedHookLoadPackage {
